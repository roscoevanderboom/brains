...
export type JSXPreviewContentProps = Omit<ComponentProps<"div">, "children"> & {
  blacklistedAttrs?: JsxParserProps["blacklistedAttrs"];
  blacklistedTags?: JsxParserProps["blacklistedTags"];
  autoCloseVoidElements?: JsxParserProps["autoCloseVoidElements"];
  allowUnknownElements?: JsxParserProps["allowUnknownElements"];
};
    ...
    return (
      <div className={cn("jsx-preview-content", className)} {...props}>
        <JsxParser
          ...
          {...(blacklistedAttrs !== undefined && { blacklistedAttrs })}
          {...(blacklistedTags !== undefined && { blacklistedTags })}
          {...(autoCloseVoidElements !== undefined && { autoCloseVoidElements })}
          {...(allowUnknownElements !== undefined && { allowUnknownElements })}
        />
      </div>
    );
  }
